...
const bookSectionLoad = (function(){
    ...
    const _createBookSection = function(){
        ...
        const nameText2 = createElement({htmlElement: 'p', parent: div1});
        ...
        const phoneText2 = createElement({htmlElement: 'p', parent: div2});
        ...
        const emailText2 = createElement({htmlElement: 'p', parent: div3});
        ...
        const personsText2 = createElement({htmlElement: 'p', parent: div4});

        const div5 = createElement({htmlElement: 'div', parent: form});
        const date = createElement({htmlElement: 'input', parent: div5, attr: [['type', 'datetime-local'], ['name', 'date'], ['placeholder', 'mm/dd/yyyy'], ['required', '']]});
        const dateText = createElement({htmlElement: 'p', parent: div5});
        const dateText2 = createElement({htmlElement: 'p', parent: div5});

        const button = createElement({htmlElement: 'button', parent: form, attr: [['type', 'submit'], ['class', 'btn'], ['form', 'form1']]});
        ...
        dateText.textContent = 'Enter date in the format of: mm/dd/yyyy, hh:mm PM/AM';
        phoneText2.textContent = 'This field is required';
        emailText2.textContent = 'This field is required';
        personsText2.textContent = 'This field is required';
        dateText2.textContent = 'This field is required';
        nameText2.textContent = 'This field is required';
    };
